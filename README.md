...
| **Enterprise** | Custom | Unlimited | Unlimited | Dedicated CSM + SLA |

Annual billing: **20% discount**. Extra numbers: **$8/mo** add-on.
Meta WhatsApp message fees are charged separately by Meta directly to your WhatsApp Business Account — WhatAgent charges only for platform access.
